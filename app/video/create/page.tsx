...
export default function CreateVideoPage() {
  ...
  const handleSaveAndPost = async () => {
    ...
    if (recordedBlob) {
      try {
        base64VideoData = await new Promise<string>((resolve) => {
        ...
        console.warn('FileReader video conversion notice:', e);
      }
    }
    ...
    const newVideo = {
      ...
      videoUrl: base64VideoData || recordedVideoUrl,
      creatorName: profile.name || 'Senior Creator'
    };
    ...
    try {
      await fetch('/api/videos', {
        ...
        body: JSON.stringify({
          topic: finalTopic,
          description: finalDescription,
          videoUrl: recordedVideoUrl || 'video-recorded',

        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          <div id="roles" className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
            ...
            <div className="bg-white rounded-3xl p-8 border-2 border-[#031635] shadow-xl hover:shadow-2xl transition flex flex-col justify-between group relative overflow-hidden">
              ...
              <div>
                <div className="w-14 h-14 rounded-2xl bg-[#031635] text-white flex items-center justify-center text-3xl mb-6 shadow-md">
                  👴🏽
                </div>

                <span className="text-xs uppercase font-black text-[#FDBC13] bg-[#031635] px-3 py-1 rounded-full tracking-wider inline-block mb-3">
                  Option 1: Senior Master / Artisan
                </span>
                ...
                <p className="text-sm font-semibold text-[#44474E] leading-relaxed mb-6">
                  Are you an elder artisan, tailor, teacher, cook, or musician? Join with <strong>Voice AI Onboarding</strong> (no typing required) and start receiving orders and 1-on-1 bookings.
                </p>

                <ul className="space-y-2.5 mb-8 text-xs font-bold text-[#44474E]">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> 100% Voice-Guided Interactive Onboarding
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> Face ID & Voice PIN Biometric Login
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> Sell Crafts & Conduct Paid Masterclasses
                  </li>
                </ul>
              </div>
              ...
              <Link
                href="/provider"
                className="w-full py-4 bg-[#031635] hover:bg-[#031635]/90 text-[#FDBC13] font-extrabold text-sm rounded-2xl shadow-md transition flex items-center justify-center gap-2 group-hover:scale-[1.02]"
              >
                Enter Service Provider Portal <ArrowRight className="w-4 h-4" />
              </Link>
            </div>

            {/* ROLE 2: CONSUMER / LEARNER */}
            <div className="bg-white rounded-3xl p-8 border-2 border-[#FDBC13] shadow-xl hover:shadow-2xl transition flex flex-col justify-between group relative overflow-hidden">
              ...
              <div>
                <div className="w-14 h-14 rounded-2xl bg-[#FDBC13] text-[#031635] flex items-center justify-center text-3xl mb-6 shadow-md">
                  🛒
                </div>

                <span className="text-xs uppercase font-black text-[#031635] bg-[#FDBC13] px-3 py-1 rounded-full tracking-wider inline-block mb-3">
                ...
                <ul className="space-y-2.5 mb-8 text-xs font-bold text-[#44474E]">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> Buy Direct from Verified Elder Creators
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> Free Educational Video Streaming
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-4 h-4 text-[#2D5A27]" /> AI Matchmaker & 1-on-1 Mentorship Booking
                  </li>
                </ul>
              </div>
        ...
        <div className="max-w-screen-2xl mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#FAF9F6] p-8 rounded-3xl border border-[#E3E2E0] space-y-4">
              ...
              <h3 className="text-xl font-black text-[#031635]">1-on-1 Live Mentorship</h3>
              <p className="text-sm font-semibold text-[#44474E] leading-relaxed">
                Direct interactive video appointments where customers learn personalized stitching, cooking secret recipes, and gardening tips from experienced elders.
              </p>
            </div>
